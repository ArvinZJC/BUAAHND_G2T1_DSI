//2017.11.21, LS3.docx, Exercise 2, program written for practising writing statements that perform the 3 simple 1-dimensional-array operations
...
public class LS3_E2
{
	...
	public static void TaskA()
	{
		...
		{
			System.out.printf( "%d  ", counts[ counter ] );
			counts[ counter ] = 0;
		} //end for
	...
	public static void TaskB()
	{
		...
		{
			System.out.printf( "%d  ", bonus[ counter ] );
			bonus[ counter ] += 1;
		} //end for
