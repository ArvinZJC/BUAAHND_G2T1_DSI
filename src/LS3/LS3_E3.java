// LS3.docx, Exercise 3, simplified airline reservations system
...
public class LS3_E3
{
	...
	private static int seat; // numbers 1-10 each represent Seats 1-10 and 0 represents that there is no remaining seat in First Class or Economy
	/*
