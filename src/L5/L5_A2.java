/*
 * 2017.11.04, Assignment 2, program that gets the max of 3 numberbers using a programmer-declared method
...
public class L5_A2
{
	public static void main( String[] args )
	{
		...
		while( run != 0 )
		{
			System.out.print( "Enter 3 numberbers each separated by a space: " );
