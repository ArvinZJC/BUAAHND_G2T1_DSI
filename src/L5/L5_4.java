// jhtp8LOV_ch04.pptx, P87, program that displays truth tables of logic operators
...
public class L5_4
{
	...
	{
		System.out.printf("%s\n%s: %b\n%s: %b\n%s: %b\n%s: %b\n\n", // the format specifier "%b" displays the word "true" or "false" based on a boolean expression's value
				"Condition AND (&&)",
