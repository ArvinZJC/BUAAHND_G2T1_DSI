// jhtp8LOV_ch05.pptx, P77 & 78, program that demonstrates field and local variable scopes
...
public class L7_1
{
	...
	public static void main(String[] args)
	{
		...
		LocalVariable(); // call the specified method to create and initialise the local variable "x"
		Field(); // call the specified method to modify this class's field "x"
		LocalVariable(); // call the specified method to create and initialise the local variable "x"
		Field(); // call the specified method to modify this class's field "x"
