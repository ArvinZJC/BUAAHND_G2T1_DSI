//2017.12.11, jhtp8LOV_ch07.pptx, P68-70, class PackOfCard (with a programmer-declared constructor) that can represent a pack of playing cards
...
public class PackOfCard
{
	...
	public PackOfCard()
	{
	    ...
	    for( int counter = 0; counter < pack.length; counter++ )
	    	pack[ counter ] = new Card( cardFace[ counter % 13 ], cardSuit[ counter / 13 ] );
