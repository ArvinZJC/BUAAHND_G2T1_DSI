// jhtp8LOV_ch06.pptx, P66 - 73, program that summarises grades using a 2-dimensional array to store grades
...
public class L8_4
{
	...
	{		
		...
		for (int count = 0; count < frequency.length; count++)
		{
			...
			for (int asterisk = 0; asterisk < frequency[ count ]; asterisk++)
				System.out.print("*");
