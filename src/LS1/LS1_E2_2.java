/* 
 * 2017.11.01, an extension of Exercise 2, sales commission calculator
 * this program rewritten from LS1_E2_1.java is capable of calculating more than one salesperson's sales commission
 */
...
public class LS1_E2_2
{
	public static void main( String[] args )
	{
		...
		int amount1, amount2, amount3, amount4, counter = 0, run = 1;
