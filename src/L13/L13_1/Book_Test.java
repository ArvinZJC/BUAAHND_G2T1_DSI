// jhtp8LOV_ch08.pptx, P67 & 68, program that uses enum type Book
...
public class Book_Test
{
	public static void main(String[] args)
	{
		...
		for (Book book : Book.values())
	    	System.out.printf("  %-5s%-45s%s\n", book, book.getTitle(), book.getCopyrightYear()); // call the specified methods in enum Book to get the title and the copyright year of a book
